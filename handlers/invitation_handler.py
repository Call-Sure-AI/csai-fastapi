    ...
    async def generate_invitation(
        ...
        try:
            ...
            async with connection as conn:
                ...
                invitation_url = f"{os.getenv('FRONTEND_URL', 'https://beta.callsure.ai')}/invite?token={token}"
                ...
                mapped_invitations = [
                    {
                        ...
                        "invitation_url": f"{os.getenv('FRONTEND_URL', 'https://beta.callsure.ai')}/invite?token={inv['token']}"
                    }
    ...
    async def send_invitation_email(self, invitation_id: str, user_id: str) -> Dict[str, str]:
        try:
            ...
            async with connection as conn:
                ...
                invitation_url = f"{os.getenv('FRONTEND_URL', 'https://beta.callsure.ai')}/invite?token={invitation['token']}"
